      ...
      <div className="mb-8 grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Account linking is processed via backend API with signed state validation.
            </CardDescription>
          </CardHeader>
        </Card>
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" />
              <span>Backend exchanges code and securely stores access and refresh tokens.</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="mt-0.5 h-5 w-5 flex-shrink-0 text-green-600" />
              <span>You are returned to the project Avito page with connection status.</span>
            </li>
          </ul>
        </CardContent>
      </Card>
