...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md border border-[hsl(var(--input))] bg-transparent px-3 py-2 text-sm shadow-sm",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "data-[state=open]:animate-[dropdown-show_150ms_ease-out]",
        "data-[state=closed]:animate-[dropdown-hide_100ms_ease-in]",
        position === "popper" &&
